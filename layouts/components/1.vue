...
<template>
  ...
  >
    ...
    <div class="relative break-words print:border space-y-1">
      <div class="pt-2">
        <div class="sticky top-0 z-10 bg-white px-6 dark:bg-dark-900">
          <button
                ...
                >
                  <div class="flex min-w-0 items-center gap-3">
                    <svg
                      ...
                      stroke-width="1.5"
                      viewBox="0 0 24 24"
                      class="size-5 shrink-0 stroke-[1.5]"
                    >
                      <path
                        stroke="currentColor"
                  ...
                  <div
                    class="absolute bottom-1 top-1 w-1 bg-red-600 dark:bg-red-400 ltr:left-0 ltr:rounded-r-full rtl:right-0 rtl:rounded-l-lg"
                  ></div>
                </div>
              </div>
            </div>
